<?php
        ...
        PG_Blocks::register_block_type( array(
            ...
            'enqueue_style' => cover3d_plugin_base_url() . '/assets/style-min.css',
            'render_template' => 'blocks/book/book.php',
            'supports' => array('color' => array('background' => false,'text' => false,'gradients' => false,'link' => false,),'typography' => array('fontSize' => false,),'anchor' => false,'align' => false,),
            'base_url' => cover3d_plugin_base_url(),
            'base_path' => cover3d_plugin_base_path(),
            ...
            'attributes' => array(
                ...
                'book_cover_img' => array(
                    'type' => 'object',
                    'default' => array('id' => 0, 'url' => esc_url( cover3d_plugin_base_url() . '/assets/cover.png' ), 'size' => '', 'svg' => '', 'alt' => null)
                )
            ),
            'example' => array(
