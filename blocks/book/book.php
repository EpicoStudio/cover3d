    ...
    <div class="book-cover-wrapper">
        ...
        <?php endif; ?>
            <div class="book-cover-container" id="<?php echo "book-cover-container-" . $block_id; ?>">
                <div class="book-cover-image" data-download-text="<?php echo PG_Blocks::getAttribute( $args, 'back_cover_text' ) ?>" data-icon="<?php echo PG_Blocks::getAttribute( $args, 'back_cover_icon_type' ) ?>" data-size="<?php echo PG_Blocks::getAttribute( $args, 'book_size' ) ?>">
                    <picture>
